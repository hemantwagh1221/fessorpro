...
# data=yf.download(ticker1,start='2025-10-01',end='2025-10-11',interval='30m',multi_level_index=False)
# print(data)

data=yf.download(ticker1,start='2025-10-01',end='2025-10-08',interval='1m',multi_level_index=False,ignore_tz=True)
print(data)